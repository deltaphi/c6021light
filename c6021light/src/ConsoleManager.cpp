...
static const cliSupport::Argument argtable[] = {
    {app_set_turnout_protocol, configArguments, run_app_set_turnout_protocol},
    {app_get_turnout_protocol, nullptr, run_app_get_turnout_protocol},
    {app_help, nullptr, run_app_help},
    {app_save, nullptr, run_app_save},
    {app_dump_flash, nullptr, run_app_dump_flash},
    {nullptr, nullptr}};
...
int run_app_help(int, const char* const*, int argcMatched) {
