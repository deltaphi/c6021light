...
#elif defined(STM32F1) // c6021light/Bluepill/STM32F1
// HAL includes
#include <libopencm3/stm32/usart.h>
#include <libopencm3/cm3/nvic.h>

// define which USART instance to use
#define XN_USART_INST	USART2
#define XN_USART_BANK	GPIOA
#define XN_USART_TX_PIN	GPIO_USART2_TX
#define XN_USART_RX_PIN	GPIO_USART2_RX

#define XN_USART_IRQ	NVIC_USART2_IRQ

#define XN_TXEN_BANK	GPIOA
#define XN_TXEN_PIN		GPIO1
...
#define MY_ADDRESS 0x5A	//only for SLAVE-MODE Adr=31 (0x5F) or Adr=26 (0x5A)!
...
class XpressNetMasterClass
{
  ...
  public:
	...
	void RAW_serial_read(unsigned int data);
	#endif
...
extern XpressNetMasterClass XpressNet;

#if defined (__cplusplus)
	extern "C" {
#endif
	#if defined(RAW_DATA_MODE)
	extern void XpressNet_RAW_send(uint32_t data) __attribute__((weak));
	#endif
	#if defined(STM32F1)
	extern void notifyXNetGlobal() __attribute__((weak));
	#endif
